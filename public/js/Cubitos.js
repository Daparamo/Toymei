String.prototype.format = function () {
			...
			function init() {
				...
				container = document.createElement( 'cajon2' );
				...
				var info = document.createElement( 'cajon2' );
				info.style.position = 'absolute';
				info.style.top = '10px';
				info.style.width = '100%';
				info.style.textAlign = 'center';
				//info.innerHTML = 'catmull-rom rom spline comparisions';
				options = document.createElement( 'cajon2' );
...
*/
			...
			function render() {
				...
				//splines.uniform.mesh.visible = uniform.checked=false;
				//splines.centripetal.mesh.visible = centripetal.checked=false;
				//splines.chordal.mesh.visible = chordal.checked=false;
