    ...
    $("#form").submit(function(event)
    {
        ...
        if(enviaForm)
        {
            ...
            if(!validaPassword($("#nueva_contrasena").val()))
            {
                ...
                swal
                        ({  
                            ...
                            title   : "Oops :(",   
                            text    : "La contraseña debe tener minimo mayusculas-minuscula-caracter especial- sin espacio en blanco",   
                            timer   : 2000,
                            type    : "error",  
                            showConfirmButton: false 
                        });
            ...
            else
            {
                    ...
                    {
                        sweetAlert("Password Fail", "Las contraseñas no coinciden.", "error");
                       $("#nueva_contrasena").val("");
                       $("#confirmar_contrasena").val("");
                        enviaForm = false;
                    }
